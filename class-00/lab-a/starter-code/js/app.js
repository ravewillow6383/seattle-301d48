...
function displayPics(){
  ...
  // The console log can't read 'rando' because let defined rando only inside of the block, while the console log is outside of the function, therefore outside of the block. Once I removed the console.log the index ran properly in the browser again.
  console.log(viewed);
