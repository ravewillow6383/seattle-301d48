...
// I returned the code on lines 149 and 165 to how they originally were here in the starter code after the arrow function did not work with them.
...
//    In my console in my browser, once I turned Student.prototype into an arrow function, the console log printed out the entire global window object so I would say that 'this' just doesn't work in the context of an arrow function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//It was exactly the same as the previous question. Because arrow functions do not bind 'this', it refered to the window object which was its scope.
// 3. Explain why "this" is different when an arrow function is used.
//it's different because arrow functions do not bind 'this' like regular functions do within constructors. Instead it bubbles up to the next nearest scope.
